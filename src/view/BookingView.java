...
public class BookingView extends Layout {
    ...
    public BookingView(Car selectedCar, String strt_date, String fnsh_date) {
        ...
        JLabel var10000 = this.lbl_car_info;
        String var10001 = this.car.getPlate();
        var10000.setText("Araç : " + var10001 + " / " + this.car.getModel().getBrand().getName() + " / " + this.car.getModel().getName());
        ...
        this.btn_book_save.addActionListener((e) -> {
            JTextField[] checkFieldList = new JTextField[]{this.fld_book_name, this.fld_book_mail, this.fld_book_prc, this.fld_book_mpno, this.fld_book_idno, this.fld_book_strt_date, this.fld_book_fnsh_date};
