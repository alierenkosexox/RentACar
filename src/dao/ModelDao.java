...
public class ModelDao {
    ...
    public Model match(ResultSet rs) throws SQLException {
        ...
        model.setFuel(Fuel.valueOf(rs.getString("model_fuel")));
        model.setGear(Gear.valueOf(rs.getString("model_gear")));
        model.setType(Type.valueOf(rs.getString("model_type")));
